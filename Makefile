...
popTest: distributeART.o distributeCondoms.o addBirths.o csvUtil.o
	$(CC) $(CFLAGS) -o popTest main.cpp distributeART.o distributeCondoms.o addBirths.cpp csvUtil.o
